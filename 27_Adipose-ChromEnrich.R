##############################################################
# SCRIPT 27: Adipose - Chromatin enrichment
##############################################################
# Setup
rm(list=ls())
library(tidyverse)
...
write_csv(res %>% arrange(p, OR),
          file="../GOTO_Data/Tables/ST11.csv")
...
# Fig. 3a
png("../GOTO_Data/Chromatin_States/OR-Plot_Chromatin-fat.png", 
...
write_tsv(homer, file='../GOTO_Data/Homer/Fat_HomerInput.tsv')

...
# Load data
load('../GOTO_Data/eQTM/blood_gene_cpg_pairs.Rdata')
...
deg <- read.table('DEGs_blood_postprandial_combined_new.txt')
...
# Save
write_csv(out, file='../GOTO_Data/eQTM/Blood_DEG.csv')

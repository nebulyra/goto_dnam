##############################################################
# SCRIPT 20: Muscle - DEGs near CpGs
##############################################################
# Setup
rm(list=ls())
library(tidyverse)
...
# Load data
load('../GOTO_Data/eQTM/muscle_gene_cpg_pairs.Rdata')
...
deg <- read.table('DEGs_muscle_postprandial_combined_new.txt')
...
# Save
write_csv(out, file='../GOTO_Data/eQTM/Muscle_DEG.csv')

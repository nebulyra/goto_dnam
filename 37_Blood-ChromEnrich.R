##############################################################
# SCRIPT 37: Blood - Chromatin enrichment
##############################################################
# Setup
rm(list=ls())
library(tidyverse)
...
write_csv(res %>% arrange(p, OR),
          file="../GOTO_Data/Tables/ST17.csv")
...
# Fig. 3a
png("../GOTO_Data/Chromatin_States/OR-Plot_Chromatin-blood.png", 
...
write_tsv(homer, file='../GOTO_Data/Homer/Blood_HomerInput.tsv')
